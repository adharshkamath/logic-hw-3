...
unsat
	...
	\begin{align*}
		...
		= \forall x. ((\frac{10}{-2} > x) \land (\frac{-10}{2} < x)) \\
	...
	\begin{align*}
		\neg \exists x. \neg ((20 > x) \land (20 < x))
	\end{align*}
	Consider the inner quantified formula:
	\begin{align*}
		\neg ((20 > x) \land (20 < x))
	\end{align*}
	Defining the sub-formulae in the Ferrante-Rackoff procedure:
	\begin{align*}
		\psi_1 = (20 > (20 + 20) / 2) \land (20 < (20 + 20) / 2) \\
		\psi_{-\infty} = \bot \land \top \\
		\psi_{+\infty} = \top \land \bot
	\end{align*}
	The final formula can be written as:
	...
	\begin{align*}
		\neg \exists x. \neg ((20 > x) \land (20 < x)) = \neg (\bot) = \top
	\end{align*}
	Therefore, the given formula simplifies to $ \top $. \\
